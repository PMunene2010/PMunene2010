...
💻 IT Support Specialist | ⚙️ DevOps Engineer | ☁️ Aspiring Cloud Engineer  

From Supporting Systems → Automating Infrastructure → Building Cloud Solutions.

---

## 👨‍💻 Professional Summary

I am an IT Support Specialist with strong experience in enterprise IT environments, systems administration, and technical support.

I am currently growing into DevOps Engineering, focusing on automation, CI/CD practices, and infrastructure optimization, while actively progressing toward Cloud Engineering.

My goal is to evolve from supporting systems to building and managing scalable cloud-native infrastructure.
...
## ⚙️ DevOps Engineering Focus

- Process Automation (PowerShell, Bash)  
- Git & GitHub Version Control  
- Azure CLI Automation  
- CI/CD Concepts & Pipeline Awareness  
...
## ☁️ Aspiring Cloud Engineer Path

- Microsoft Azure Fundamentals  
- Azure Virtual Machines  
- Azure Networking  
- Identity & Access Management (IAM)  
- Cloud Resource Deployment & Management  
...
IT administration & user provisioning automation  
...
- ⚙️ Strengthen DevOps engineering skills  
- 📦 Master Infrastructure as Code (Terraform)  
- ☁️ Transition fully into Cloud Engineering  
- 🔐 Improve Cloud Security & Monitoring  
- 🎓 Earn Azure Certifications (AZ-900 → AZ-104)  
